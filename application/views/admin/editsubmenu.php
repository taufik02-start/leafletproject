    ...
    <div class="row">
      <div class="col-md-7">
        <div class="box box-primary">
          <div class="box-body">
            <form class="" action="<?php echo base_url('menu/editSubmenu/').$submenu['id']?>" method="post">
              ...
              <div class="form-group">
                ...
                <label class="form-check-label mr-3" <?php echo ($submenu['aktif']==1)?'checked':''?>>Aktif</label>
                <input type="radio" name="status" class="form-check-input" value="0">
                <label class="form-check-label" <?php echo ($submenu['aktif']==0)?'checked':''?>>Tidak Aktif</label>
              </div>
